...
public class ReviewFactory {
	...
	public static Boolean uploadReview(String display, String section, String classname, String prof, String body, Integer year, String major) {
	...
	public static Boolean editReview(String body, Integer id) {
